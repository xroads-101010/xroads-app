...
public class TripMemberLocationResource {
	...
	public Response addTripMemberLocation(TripMemberLocationDto tripMemberLocationDto ){
		...
		tripMemberLocation.setTripMemberId(tripMemberLocationDto.getTripMemberId());
		...
		tripMemberLocationDao.addMemberLocation(tripMemberLocation);
		return Response.ok().build();
	}
	
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Response updateTripMemberLocation(TripMemberLocationDto tripMemberLocationDto){
		TripMemberLocation tripMemberLocation = new TripMemberLocation();
		tripMemberLocation.setTripMemberId(tripMemberLocationDto.getTripMemberId());
		tripMemberLocation.setCurrentLocation(tripMemberLocationDto.getLocation());
		tripMemberLocation.setUpdatedAt(new DateTime());
		tripMemberLocationDao.updateMemberLocation(tripMemberLocation);
		return Response.ok().build();
	}
